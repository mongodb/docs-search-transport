const resultMapping: ResultMapping = {
    ...
    findbyidandupdate: ['reference/command/findAndModify', 'reference/method/db.collection.findAndModify', 'partner-integrations'],
    ...
    'and operator': ['reference/operator/query/and', 'reference/operator/aggregation/and', 'reference/operator/query/all'],
    'in operator': ['reference/operator/query/in', 'reference/operator/aggregation/in', 'reference/operator/query/all'],
    'mongodb.conf': ['administration/configuration', 'reference/configuration-file-settings-command-line-options-mapping', 'reference/program/mongod'],
    'createcollection': ['reference/method/db.createCollection', 'reference/command/create', 'core/databases-and-collections'],
    ...
    '$project': ['reference/operator/aggregation/project', 'core/aggregation-pipeline-optimization', 'reference/map-reduce-to-aggregation-pipeline'],
    project: ['reference/operator/aggregation/project', 'core/aggregation-pipeline-optimization', 'reference/map-reduce-to-aggregation-pipeline'],
    group: ['reference/operator/aggregation/group', 'core/aggregation-pipeline', 'reference/map-reduce-to-aggregation-pipeline'],
    ...
    set: ['reference/operator/update/set', 'reference/operator/aggregation/set', 'tutorial/update-documents-with-aggregation-pipeline'],
    map: ['reference/operator/aggregation/map', 'tutorial/update-documents-with-aggregation-pipeline', 'tutorial/implement-field-level-redaction'],
    limit: ['reference/operator/aggregation/limit', 'reference/method/cursor.limit/', 'reference/sql-aggregation-comparison'],
    ...
    mongoclient: ['fundamentals/connection/mongoclientsettings', 'fundamentals/connection/mongoclientsettings', 'sdk/java/api/io/realm/mongodb/mongo/MongoClient'],
    mongocli: ['command/mongocli', 'install', 'configure'],
    connection: ['reference/connection-string', 'reference/command/serverStatus', 'administration/connection-pool-overview'],
    ...
    select: ['reference/sql-comparison', 'reference/sql-aggregation-comparison', 'tutorial/project-fields-from-query-results'],
